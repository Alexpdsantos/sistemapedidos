...
import com.alexsantos.sistemapedidos.domain.Pagamento;
import com.alexsantos.sistemapedidos.domain.PagamentoComBoleto;
import com.alexsantos.sistemapedidos.domain.PagamentoComCartao;
import com.alexsantos.sistemapedidos.domain.Pedido;
import com.alexsantos.sistemapedidos.domain.Produto;
import com.alexsantos.sistemapedidos.domain.enums.EstadoPagamento;
...
import com.alexsantos.sistemapedidos.repositories.ItemPedidoRepository;
import com.alexsantos.sistemapedidos.repositories.PagamentoRepository;
...
public class SistemaPedidosApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Produto p3 = new Produto(null, "Mouse óptico", 80);
		Produto p4 = new Produto(null, "Mesa de Escritório", 300.00);
		Produto p5 = new Produto(null, "Toalha", 50.00);
		Produto p6 = new Produto(null, "Colcha", 200.00);
		Produto p7 = new Produto(null, "TV True color", 1200.00);
		Produto p8 = new Produto(null, "Roçadeira", 800.00);
		Produto p9 = new Produto(null, "Abaur", 100.00);
		...
		Cliente cli1 = new Cliente(null, "Alex Santos", "lequinsantos@gmail.com", "39735380854",
		...
		Endereco e2 = new Endereco(null, "Rua Benedito de Oliveira", "200", "apto 1", "Jd das flores", "13880980", cli1,
				c1);
